...
export default function Home() {
  ...
  const submitCheckSlot = async () => {
    ...
    while (currentDate <= new Date(endDate)) {
      ...
      // console.log(date, dayOfWeek," date, dayOfWeek" );
      ...
      selectedParticipants.forEach((participant) => {
        ...
        if (
          ...
          participantAvailability[participant][dayOfWeek]
        ) {
          participantAvailability[participant][dayOfWeek]?.forEach(
            ({ start, end }) => {
              ...
              // console.log(participantSlots, "participant slot");
            }
          );
        }
        ...
        if (repeatedValues === null) {
          ...
          repeatedValues = repeatedValues.filter((value: any) =>
            participantSlots.includes(value)
          );
        }

        if (schedules[participant] && schedules[participant][date]) {
        ...
        //
        repeatedValues = repeatedValues.filter(
          (value: any) => !scheduleSlots.includes(value)
        );
      });
